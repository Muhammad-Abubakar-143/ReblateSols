  ...
  return (
    <>
      <div className="md:pt-[90px] pt-[80px]">
        ...
        <div className="text-left px-4 mt-4 md:pb-[90px] pb-[40px] md:px-7 max-w-5xl mx-auto">
          <h1 className="font-black md:text-[60px] text-[50px] text-[#14213d] text-center">Join Reblate Solutions</h1>
          <h2 className="font-medium text-[#14213d] text-[20px] md:text-[25px] mt-3">Where Your Career Takes Flight</h2> 
      ...
      <div className="p-4 md:pl-7">
        <h1 className="font-bold md:text-[60px] text-[#14213d] text-[50px]">Explore Opportunities</h1>
      </div>
